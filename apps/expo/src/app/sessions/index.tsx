      ...
      <ScrollView>
        ...
        <View className="mt-10 flex flex-col items-center justify-center ">
          <P style="text-center px-2">
            We’ve sent an appointment request to the professional. If they
            accept, you will receive confirmation and a calendar invite.
          </P>
          ...
          <TouchableOpacity className="h-12 w-[350px] rounded-md bg-[#1960F2]">
