...
export default function Nav() {
    ...
    return (
        <nav className="bg-cream relative">
            ...
            <div className="hidden lg:flex md:items-center lg:justify-between lg:px-[40px] lg:py-[20px] ">
                <a href="/">
                <img
                alt="logo"
                src="/imgs/logo-2.png"
                ...
                <div className="">
            <ul className="text-blue flex items-center md:flex lg:gap-x-[30px]">
                <a href="/about-us">
                <li>About Us</li>
                </a>
             ...
             <button className ="w-[150px] h-[47px] lg:w-[200px] lg:py-[20px] lg:h-[70px]  rounded-[4px] bg-black text-white text-[15px] lg:text-[20px]">
                Get Involved
             </button> 
            </div>
        </nav>
...
function MobileNav({setIsOpen}: {setIsOpen: Dispatch<SetStateAction<boolean>>}) {
    return (
        <section className="absolute z-[999] top-0 left-0 w-full h-screen bg-cream ">
            <button className="right-5 top-5 absolute"
            onClick={() => setIsOpen(false)}
            >
            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M28.2082 3.55324L25.4469 0.791992L14.4998 11.7391L3.55275 0.791992L0.791504 3.55324L11.7386 14.5003L0.791504 25.4474L3.55275 28.2087L14.4998 17.2616L25.4469 28.2087L28.2082 25.4474L17.2611 14.5003L28.2082 3.55324Z" fill="#066393"/>
            </svg>
            </button>
        <ul className="text-blue pl-[40px] pt-[50px] flex flex-col  space-y-[20px] text-[16px]">
            <a href="/">
            <li>Home</li>
            </a>
            ...
            <a href="/get-involved">
            <li>
               <button className ="w-[150px] h-[47px] lg:w-[261px] lg:py-[26px] lg:h-[81px]  rounded-[4px] bg-orange text-white text-[15px] lg:text-[26px]">
                Get Involved
                </button>
            </li>
            </a>
